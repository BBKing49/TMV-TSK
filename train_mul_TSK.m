...
N = size(ulabelX{1,1},1);   %伪标记样本数 %改过
lamda1 = options.lamda1;    %正则化系数
lamda2 = options.lamda2;    %协同项系数
lamda3 = options.lamda3;    %权值项系数
